...
// By defining these components outside of the main component, we prevent them
// from being re-created on every render, which was causing the input fields to lose focus.
...
// --- MAIN APP COMPONENT ---
// This component now holds all the state and logic. It passes the necessary
// data and functions down to the child components as props.
const RecruitmentPlatform = () => {
  ...
  if (currentView === "login") {
    ...
    // Default to login view if no user or token
    return (
        <LoginForm
            loginForm={loginForm}
            setLoginForm={setLoginForm}
